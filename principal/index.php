...
if (isset($_POST['submit'])) {
	...
	$sql = "SELECT * FROM userd WHERE email='$email' AND password='$password'";
...
<body>
	<div class="container">
		<form action="" method="POST" class="login-email">
			<p class="login-text" style="font-size: 2rem; font-weight: 800;">Principal login</p>
      ...
      <div class="input-group">
      <button name="submit" class="btn"onclick="history.back()">Go Back</button>
      </div>
